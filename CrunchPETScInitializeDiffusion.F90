...
call VecCreateSeqWithArray(PETSC_COMM_SELF,nxyz,nxyz,BvecCrunchD,bvecD,ierr)
call VecCreateSeqWithArray(PETSC_COMM_SELF,nxyz,nxyz,XvecCrunchD,xvecD,ierr)
