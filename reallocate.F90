...
!!SUBROUTINE REALLOCATE(ncomp,nspec,nrct,nkin,ngas,nsurf,nexchange,ikin,nexch_sec,nsurf_sec,nchem,ninhibitaqmax,nmonodaqmax,nreactmax,ntot,nreactkinmax,ninhibitmax)
USE crunchtype
USE params
USE runtime
USE concentration
