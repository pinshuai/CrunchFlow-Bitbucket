...
call VecCreateSeqWithArray(PETSC_COMM_SELF,nxyz,nxyz,BvecCrunchP,bvecP,ierr)
call VecCreateSeqWithArray(PETSC_COMM_SELF,nxyz,nxyz,XvecCrunchP,xvecP,ierr)
