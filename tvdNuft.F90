...
!************** (C) COPYRIGHT 1995,1998,1999,2000 ******************
!************** ** C.I. Steefel & S.B. Yabusaki *******************
!                      All Rights Reserved

!  OS3D98 IS PROVIDED "AS IS" AND WITHOUT ANY WARRANTY EXPRESS OR IMPLIED.
!  THE USER ASSUMES ALL RISKS OF USING OS3D98. THERE IS NO CLAIM OF THE
